...
public class ProductCheckout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText(n);
        price.setText("$"+p);
        qty.setText("Stock Qty: "+q);
        totalTxt.setText("Total $"+p);
        img.setImageResource(getIntent().getIntExtra("PImage", R.drawable.screws));
    ...
    public void openDeliveryDetails(View view) {
        Intent intent = new Intent(ProductCheckout.this, DeliveryDetails.class);
//        int tot;
//        intent.putExtra(totalTxt.setText("Total $"+tot));
